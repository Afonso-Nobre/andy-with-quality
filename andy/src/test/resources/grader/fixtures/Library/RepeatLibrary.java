...
class DelftStringUtilities {
     ...
     * Supplementary Characters</a> as they require a pair of {@code char}s to be represented. If you are needing to support
     * full I18N of your applications consider using {@link #repeat(String, int)} instead.
     *
