...
class AutoAssignerTest {
    ...
    void all_students_in_the_same_first_date() {
        List<Student> students = Arrays.asList(
                new Student(1, "Mauricio", "m.f.aniche@tudelft.nl"),
                new Student(2, "Frank", "f.mulder@tudelft.nl")
        );
    ...
    void uses_different_dates() {
        List<Student> students = Arrays.asList(
                new Student(1, "Mauricio", "m.f.aniche@tudelft.nl"),
                new Student(2, "Frank", "f.mulder@tudelft.nl"),
                new Student(3, "Martin", "m.mladenov@student.tudelft.nl"),
                new Student(4, "Sara", "s.juhosova@student.tudelft.nl")
        );
